#!/usr/bin/env python3
"""Generate Sakura chibi character images via SD Forge API"""
...
BASE_PROMPT = (
    "chibi, super deformed, 2-3 head tall, cute girl, sakura character, "
    "pink hair, blue eyes, white futuristic outfit, knee-high socks, "
    "<lora:kaina_v1:0.7>, masterpiece, best quality, simple background, white background"
)

NEGATIVE_PROMPT = "realistic, 3d, ugly, bad anatomy, blurry, watermark"
...
def generate_image(pose: str, index: int) -> str:
    ...
    print(f"[{index:02d}/10] Generating: {pose[:40]}...")
    ...
    out_path = os.path.join(OUTPUT_DIR, f"sakura_chibi_{index:02d}.png")
